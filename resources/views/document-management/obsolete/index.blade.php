    ...
    <div class="space-y-6">
        ...
        <x-ui.filter-bar :action="route('documents.obsolete')">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('documents.obsolete') }}" class="inline-flex h-10 items-center justify-center rounded-lg border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">
                    Reset
                </a>
            </div>
        </x-ui.filter-bar>
        ...
        @if ($canViewImportedExisting || $canCreateImportedExisting)
            <div class="flex flex-wrap justify-end gap-2">
                @if ($canViewImportedExisting)
                    ...
                    >
                        <x-flux.icon name="archive-box" class="size-4" />
