...
Route::middleware(['auth', 'verified', 'route.permission'])->group(function () {
    ...
    Route::get('access-groups', AccessGroupIndex::class)->name('access-groups.index');
    Route::get('access-menus', AccessMenuIndex::class)->name('access-menus.index');
    Route::get('approval-flows', ApprovalFlowIndex::class)->name('approval-flows.index');
    Route::get('master-data/process-functions', BusinessFunctionIndex::class)->name('master-data.process-functions');
    Route::get('master-data/business-processes', BusinessProcessIndex::class)->name('master-data.business-processes');
